            ...
            let content = `
              <li class="news-item">
                 ...
                 <div class="news-content">
                    <h4 class="news-title"><a href="/news/${one_news.id}/" target="_blank">${one_news.title}</a></h4>
      ...
      .done(function (res) {
        if (res.errno === "0") {
          ...
          res.data.banners.forEach(function (one_banner, index) {
            if (index === 0){
              content = `
                <li style="display:block;"><a href="/news/${one_banner.news_id}/" target="_blank">
                 <img src="${one_banner.image_url}" alt="${one_banner.news_title}"></a></li>
              `;
              tab_content = `<li class="active"></li>`;
            } else {
              content = `
              <li><a href="/news/${one_banner.news_id}/" target="_blank"><img src="${one_banner.image_url}" alt="${one_banner.news_title}"></a></li>
              `;
              tab_content = `<li></li>`;
            }
